...
public class ReviewScoreWindow extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        //com.sun.awt.AWTUtilities.setWindowOpacity(r, 0.9f);
        /*r.setUndecorated(true);
        r.getContentPane().setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));
        r.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));*/
